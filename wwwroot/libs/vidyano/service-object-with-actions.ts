...
/**
 * A service object that supports executing actions.
 */
export class ServiceObjectWithActions extends ServiceObject {
    ...
    /**
     * Creates a new instance of ServiceObjectWithActions.
     ...
     * @param skipShowNotification - If true, the notification is not shown.
     */
     ...
     * @param notification - The error to extract the notification message from.
     * @param type - The type of the notification.
     * @param duration - The duration of the notification.
     * @param skipShowNotification - If true, the notification is not shown.
     */
